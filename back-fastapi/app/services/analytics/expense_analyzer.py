...
class ExpenseAnalyzer:
    ...
    async def analyze_spending_trends(
        ...
        try:
            ...
            analysis = await self.openai_client.analyze_expenses(
                prompts.SPENDING_TRENDS_PROMPT,
                formatted_data
            )
    ...
    async def get_budget_recommendations(
        ...
        try:
            ...
            recommendations = await self.openai_client.analyze_expenses(
                prompts.BUDGET_RECOMMENDATIONS_PROMPT,
                formatted_data,
                max_tokens=400
            )
    ...
    async def analyze_expense_categorization(
        ...
        try:
            ...
            analysis = await self.openai_client.analyze_expenses(
                prompts.EXPENSE_CATEGORIZATION_PROMPT,
                formatted_data
            )
    ...
    async def get_financial_insights(
        ...
        try:
            ...
            insights = await self.openai_client.analyze_expenses(
                prompts.FINANCIAL_INSIGHTS_PROMPT,
                formatted_data,
                max_tokens=500
            )
    ...
    async def get_monthly_summary(
        ...
        try:
            ...
            summary = await self.openai_client.analyze_expenses(
                prompts.MONTHLY_SUMMARY_PROMPT,
                formatted_data,
                max_tokens=250
            )
