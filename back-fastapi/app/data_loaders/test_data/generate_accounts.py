...
AccountData = namedtuple('AccData', 'user_id account_type_id currency_id balance name opening_date is_hidden comment')
    ...
    try:
        for user in users:
            for currency in currencies:
                ...
                acc_data0 = AccountData(user_id=user.id, account_type_id=account_types[0].id,
                ...
                acc_data1 = AccountData(user_id=user.id, account_type_id=account_types[0].id,
