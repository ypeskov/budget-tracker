...
def read_pkg_file(self, file):
    ...
    self.notes = _read_field_unescaped_from_msg(msg, 'description')
    if self.notes is None and self.metadata_version >= version.Version(
        '2.1'
    ):
        self.notes = _read_payload_from_msg(msg)
    self.description = _read_field_from_msg(msg, 'summary')
